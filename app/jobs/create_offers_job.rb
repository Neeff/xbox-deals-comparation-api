class CreateOffersJob
  ...
  def perform
    ...
    [
      ...
      { url: "https://www.xbox.com/es-cl/games/xbox-one?cat=onsale", text: 'Siguiente', region:'cl',currency: 'CLP'},
      { url: "https://www.xbox.com/es-ar/games/xbox-one?cat=onsale&source=lp#%20c-hyperlink", text: 'Siguiente', region: 'ar', currency: 'ARS'}
    ]
